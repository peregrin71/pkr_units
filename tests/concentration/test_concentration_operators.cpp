...
TEST_F(SiConcentrationOperatorsTest, add_molar)
{
    ...
    pkr::units::molar_concentration_t<double> conc2(0.5);
...
{
    pkr::units::molar_concentration_t<double> conc1(1.0);        // 1 M
    pkr::units::millimolar_concentration_t<double> conc2(500.0); // 500 mM = 0.5 M
    auto result = conc1 + conc2;
...
{
    pkr::units::molar_concentration_t<double> conc1(1.0);
    pkr::units::molar_concentration_t<double> conc2(1.0);
