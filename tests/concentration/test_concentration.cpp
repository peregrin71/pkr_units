...
{
    pkr::units::molar_concentration_t<double> conc1(1.0);
    pkr::units::molar_concentration_t<double> conc2(std::move(conc1));
    EXPECT_DOUBLE_EQ(*conc2, 1.0);
}
...
{
    pkr::units::molar_concentration_t<double> conc1(1.0);
    pkr::units::molar_concentration_t<double> conc2(0.0);
    conc2 = conc1;
    EXPECT_DOUBLE_EQ(*conc2, 1.0);
}
