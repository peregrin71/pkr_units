...
struct three_body_state_si_t {
    pkr::units::math::vec_4d_units_t<pkr::units::meter_t> pos1, pos2, pos3;
    pkr::units::math::vec_4d_units_t<pkr::units::meter_per_second_t> vel1, vel2, vel3;
};

// Derivative state for SI units (contains time derivatives)
struct three_body_derivative_si_t {
    pkr::units::math::vec_4d_units_t<pkr::units::meter_per_second_t> dpos1, dpos2, dpos3;  // d(position)/dt = velocity
    pkr::units::math::vec_4d_units_t<pkr::units::meter_per_second_squared_t> dvel1, dvel2, dvel3;  // d(velocity)/dt = acceleration
};

// State for measurements
struct three_body_state_measurement_t {
    pkr::units::math::vec_4d_measurements_rss_t<pkr::units::measurement_t<pkr::units::meter_t>> pos1, pos2, pos3;
    pkr::units::math::vec_4d_measurements_rss_t<pkr::units::measurement_t<pkr::units::meter_per_second_t>> vel1, vel2, vel3;
};

// Derivative state for measurements
struct three_body_derivative_measurement_t {
    pkr::units::math::vec_4d_measurements_rss_t<pkr::units::measurement_t<pkr::units::meter_per_second_t>> dpos1, dpos2, dpos3;
    pkr::units::math::vec_4d_measurements_rss_t<pkr::units::measurement_t<pkr::units::meter_per_second_squared_t>> dvel1, dvel2, dvel3;
};
...
const pkr::units::measurement_t<pkr::units::kilogram_t> m1_meas = pkr::units::measurement_t<pkr::units::kilogram_t>{pkr::units::constants::solar_mass, pkr::units::kilogram_t{pkr::units::constants::solar_mass_kg * 0.01}};
const pkr::units::measurement_t<pkr::units::kilogram_t> m2_meas = pkr::units::measurement_t<pkr::units::kilogram_t>{pkr::units::constants::solar_mass, pkr::units::kilogram_t{pkr::units::constants::solar_mass_kg * 0.01}};
const pkr::units::measurement_t<pkr::units::kilogram_t> m3_meas = pkr::units::measurement_t<pkr::units::kilogram_t>{pkr::units::constants::solar_mass, pkr::units::kilogram_t{pkr::units::constants::solar_mass_kg * 0.01}};
...
constexpr auto G_meas = pkr::units::measurement_t<decltype(pkr::units::constants::gravitational_constant)>{pkr::units::constants::gravitational_constant, decltype(pkr::units::constants::gravitational_constant){pkr::units::constants::gravitational_constant_value * 1e-5}};
...
const three_body_state_si_t initial_state_si = {
    ...
    {0.0 * pkr::units::meter_per_second_t(1.0), 0.5005 * pkr::units::au_t(1.0) / pkr::units::year_t(1.0), 0.0 * pkr::units::meter_per_second_t(1.0), 0.0 * pkr::units::meter_per_second_t(1.0)},
    {-0.4995 * pkr::units::au_t(1.0) / pkr::units::year_t(1.0), -0.2495 * pkr::units::au_t(1.0) / pkr::units::year_t(1.0), 0.0 * pkr::units::meter_per_second_t(1.0), 0.0 * pkr::units::meter_per_second_t(1.0)},
    {0.4995 * pkr::units::au_t(1.0) / pkr::units::year_t(1.0), -0.2505 * pkr::units::au_t(1.0) / pkr::units::year_t(1.0), 0.0 * pkr::units::meter_per_second_t(1.0), 0.0 * pkr::units::meter_per_second_t(1.0)}
};
...
void compute_gravitational_acceleration_double(
    ...
    double r_squared = pkr::units::math::dot(diff, diff);
    double r = std::sqrt(r_squared);
    double r_cubed = r * r_squared;

    double factor = G * mj * (1.0 / r_cubed);
    auto delta = pkr::units::math::vec_4d_t<double>{factor * diff.x, factor * diff.y, factor * diff.z, factor * diff.w};
    acc_i = acc_i + delta;
}

// Compute gravitational acceleration using stable SI units math
void compute_gravitational_acceleration_si(
    const pkr::units::math::vec_4d_units_t<pkr::units::meter_t>& pos_i,
    const pkr::units::math::vec_4d_units_t<pkr::units::meter_t>& pos_j,
    const pkr::units::kilogram_t& mj,
    pkr::units::math::vec_4d_units_t<pkr::units::meter_per_second_squared_t>& acc_i) {

    pkr::units::math::vec_4d_units_t<pkr::units::meter_t> diff = pos_j - pos_i;
    auto r_squared = pkr::units::math::dot(diff, diff);
    auto r = pkr::units::math::sqrt(r_squared);
    auto r_cubed = r * r_squared;

    auto inv_r_cubed = pkr::units::math::stable_divide(1.0, r_cubed);
    auto gm = pkr::units::math::stable_multiply(G_si, mj);
    auto factor = pkr::units::math::stable_multiply(gm, inv_r_cubed);
    acc_i = pkr::units::math::stable_add(acc_i, pkr::units::math::stable_multiply(factor, diff));
}

// Compute gravitational acceleration using RSS math for measurements
void compute_gravitational_acceleration_meas(
    const pkr::units::math::vec_4d_measurements_rss_t<pkr::units::measurement_t<pkr::units::meter_t>>& pos_i,
    const pkr::units::math::vec_4d_measurements_rss_t<pkr::units::measurement_t<pkr::units::meter_t>>& pos_j,
    const pkr::units::measurement_t<pkr::units::kilogram_t>& mj,
    pkr::units::math::vec_4d_measurements_rss_t<pkr::units::measurement_t<pkr::units::meter_per_second_squared_t>>& acc_i) {

    pkr::units::math::vec_4d_measurements_rss_t<pkr::units::measurement_t<pkr::units::meter_t>> diff = pos_j - pos_i;

    // RSS-safe computation of distance
    auto r_squared = pkr::units::math::sum_of_squares_rss(diff.x, diff.y, diff.z);

    auto r = pkr::units::math::sqrt_rss(r_squared);

    // Use cube_rss for correlated exponentiation (r^3)
    auto r_cubed = pkr::units::math::cube_rss(r);

    auto inv_r_cubed = pkr::units::math::divide_rss(1.0, r_cubed);
    auto gm = pkr::units::math::multiply_rss(G_meas, mj);
    auto factor = pkr::units::math::multiply_rss(gm, inv_r_cubed);
    acc_i = pkr::units::math::add_rss(acc_i, pkr::units::math::multiply_rss(factor, diff));
}
...
three_body_derivative_si_t derivative_si(const three_body_state_si_t& state) {
    ...
    pkr::units::math::vec_4d_units_t<pkr::units::meter_per_second_squared_t> acc1{
        0.0 * pkr::units::meter_per_second_squared_t(1.0),
        0.0 * pkr::units::meter_per_second_squared_t(1.0),
        0.0 * pkr::units::meter_per_second_squared_t(1.0),
        0.0 * pkr::units::meter_per_second_squared_t(1.0)
    };
    pkr::units::math::vec_4d_units_t<pkr::units::meter_per_second_squared_t> acc2{
        0.0 * pkr::units::meter_per_second_squared_t(1.0),
        0.0 * pkr::units::meter_per_second_squared_t(1.0),
        0.0 * pkr::units::meter_per_second_squared_t(1.0),
        0.0 * pkr::units::meter_per_second_squared_t(1.0)
    };
    pkr::units::math::vec_4d_units_t<pkr::units::meter_per_second_squared_t> acc3{
        0.0 * pkr::units::meter_per_second_squared_t(1.0),
        0.0 * pkr::units::meter_per_second_squared_t(1.0),
        0.0 * pkr::units::meter_per_second_squared_t(1.0),
        0.0 * pkr::units::meter_per_second_squared_t(1.0)
...
three_body_derivative_measurement_t derivative_meas(const three_body_state_measurement_t& state) {
    ...
    // Initialize accelerations to zero
    pkr::units::math::vec_4d_measurements_rss_t<pkr::units::measurement_t<pkr::units::meter_per_second_squared_t>> acc1{
    ...
    pkr::units::math::vec_4d_measurements_rss_t<pkr::units::measurement_t<pkr::units::meter_per_second_squared_t>> acc2{
        pkr::units::measurement_t<pkr::units::meter_per_second_squared_t>{0.0 * pkr::units::meter_per_second_squared_t(1.0), 0.0 * pkr::units::meter_per_second_squared_t(1.0)},
        pkr::units::measurement_t<pkr::units::meter_per_second_squared_t>{0.0 * pkr::units::meter_per_second_squared_t(1.0), 0.0 * pkr::units::meter_per_second_squared_t(1.0)},
        pkr::units::measurement_t<pkr::units::meter_per_second_squared_t>{0.0 * pkr::units::meter_per_second_squared_t(1.0), 0.0 * pkr::units::meter_per_second_squared_t(1.0)},
        pkr::units::measurement_t<pkr::units::meter_per_second_squared_t>{0.0 * pkr::units::meter_per_second_squared_t(1.0), 0.0 * pkr::units::meter_per_second_squared_t(1.0)}
    };
    pkr::units::math::vec_4d_measurements_rss_t<pkr::units::measurement_t<pkr::units::meter_per_second_squared_t>> acc3{
        pkr::units::measurement_t<pkr::units::meter_per_second_squared_t>{0.0 * pkr::units::meter_per_second_squared_t(1.0), 0.0 * pkr::units::meter_per_second_squared_t(1.0)},
        pkr::units::measurement_t<pkr::units::meter_per_second_squared_t>{0.0 * pkr::units::meter_per_second_squared_t(1.0), 0.0 * pkr::units::meter_per_second_squared_t(1.0)},
        pkr::units::measurement_t<pkr::units::meter_per_second_squared_t>{0.0 * pkr::units::meter_per_second_squared_t(1.0), 0.0 * pkr::units::meter_per_second_squared_t(1.0)},
        pkr::units::measurement_t<pkr::units::meter_per_second_squared_t>{0.0 * pkr::units::meter_per_second_squared_t(1.0), 0.0 * pkr::units::meter_per_second_squared_t(1.0)}
