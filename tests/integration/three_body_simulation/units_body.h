...
public:
    ...
    void rk4_step(double dt)
    {
        ...
        for (size_t i = 0; i < n; ++i)
        {
            ...
            temp_bodies[i].position = {
                pkr::units::kilometer_t<double>{new_pos.x}, pkr::units::kilometer_t<double>{new_pos.y}, pkr::units::kilometer_t<double>{new_pos.z}};
        ...
        for (size_t i = 0; i < n; ++i)
        {
            ...
            bodies[i].position = {
                pkr::units::kilometer_t<double>{final_pos.x}, pkr::units::kilometer_t<double>{final_pos.y}, pkr::units::kilometer_t<double>{final_pos.z}};
