...
{
    pkr::units::meter_t<double> m{5000.0};
    auto km = pkr::units::unit_cast<pkr::units::kilometer_t<double>>(m);
    static_assert(std::is_same_v<decltype(km), pkr::units::kilometer_t<double>>);
...
TEST_F(SiLengthCastTest, cast_kilometer_to_meter)
{
    ...
    auto m = pkr::units::unit_cast<pkr::units::meter_t<double>>(km);
    static_assert(std::is_same_v<decltype(m), pkr::units::meter_t<double>>);
    ASSERT_DOUBLE_EQ(m.value(), 2500.0);
}

TEST_F(SiLengthCastTest, cast_millimeter_to_meter)
{
    pkr::units::millimeter_t<double> mm{5000.0};
    auto m = pkr::units::unit_cast<pkr::units::meter_t<double>>(mm);
    static_assert(std::is_same_v<decltype(m), pkr::units::meter_t<double>>);
...
TEST_F(SiLengthCastTest, cast_meter_to_millimeter)
{
    ...
    auto mm = pkr::units::unit_cast<pkr::units::millimeter_t<double>>(m);
    static_assert(std::is_same_v<decltype(mm), pkr::units::millimeter_t<double>>);
    ASSERT_DOUBLE_EQ(mm.value(), 5000.0);
}

TEST_F(SiLengthCastTest, cast_kilometer_to_millimeter)
{
    [[maybe_unused]] pkr::units::kilometer_t<double> km{1.0};
    auto mm = pkr::units::unit_cast<pkr::units::millimeter_t<double>>(km);
    static_assert(std::is_same_v<decltype(mm), pkr::units::millimeter_t<double>>);
...
TEST_F(SiLengthCastTest, foot_to_meter_conversion)
{
    ...
    auto meter = pkr::units::unit_cast<pkr::units::meter_t<double>>(ft);
    static_assert(std::is_same_v<decltype(meter), pkr::units::meter_t<double>>);
...
TEST_F(SiLengthCastTest, unit_cast_zero_ratio_overhead)
{
    ...
    pkr::units::meter_t<double> m{100.0};
...
{
    pkr::units::meter_t<double> m{12.0};
    auto same = pkr::units::unit_cast<pkr::units::meter_t<double>>(m);
    static_assert(std::is_same_v<decltype(same), pkr::units::meter_t<double>>);
