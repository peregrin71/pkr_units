...
TEST_F(SiLengthFormattingTest, all_metric_prefixes_ascii)
{
    ...
    std::string test_cases[] = {
        std::format("{}", pkr::units::attometer{1.0}),      // "1 am"
        std::format("{}", pkr::units::femtometer{1.0}),     // "1 fm"
        std::format("{}", pkr::units::picometer{1.0}),      // "1 pm"
        std::format("{}", pkr::units::nanometer_t{1.0}),      // "1 nm"
        std::format("{}", pkr::units::micrometer{1.0}),     // "1 um"
        std::format("{}", pkr::units::millimeter_t{1.0}),     // "1 mm"
        std::format("{}", pkr::units::centimeter_t{1.0}),     // "1 cm"
        std::format("{}", pkr::units::decimeter_t{1.0}),      // "1 dm"
        std::format("{}", pkr::units::meter_t{1.0}),          // "1 m"
        std::format("{}", pkr::units::decameter{1.0}),      // "1 dam"
        std::format("{}", pkr::units::hectometer{1.0}),     // "1 hm"
        std::format("{}", pkr::units::kilometer_t{1.0}),      // "1 km"
        std::format("{}", pkr::units::megameter{1.0}),      // "1 Mm"
        std::format("{}", pkr::units::gigameter{1.0}),      // "1 Gm"
    };
