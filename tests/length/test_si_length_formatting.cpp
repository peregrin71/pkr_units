...
{
    pkr::units::meter_t<double> m{5.123456};
...
{
    pkr::units::nanometer_t<double> nm{100.0};
...
{
    pkr::units::decimeter_t<double> dm{3.5};
...
{
    pkr::units::centimeter_t<double> cm{42.0};
...
{
    pkr::units::decameter_t<double> dam{1.5};
...
{
    pkr::units::hectometer_t<double> hm{2.0};
...
{
    pkr::units::megameter_t<double> Mm{0.001};
    std::string result = std::format("{}", Mm);
...
{
    pkr::units::meter_t<double> m{3.141592653589793};
...
{
    pkr::units::meter_t<double> m{1234567.0};
...
{
    pkr::units::meter_t<double> m{-5.5};
    std::string result = std::format("{}", m);
...
{
    pkr::units::meter_t<double> m{3.14159};
...
TEST_F(SiLengthFormattingTest, micrometer_wide_formatting)
{
    ...
    std::wstring expected = std::wstring(L"0.5 ") + std::wstring(pkr::units::micrometer_t<double>::w_symbol);
    ASSERT_EQ(result, expected);
}

TEST_F(SiLengthFormattingTest, kilometer_wide_formatting)
{
    pkr::units::kilometer_t<double> km{2.75};
...
TEST_F(SiLengthFormattingTest, all_metric_prefixes_ascii)
{
    ...
    TestCase test_cases[] = {
        {"1 am", std::format("{}", pkr::units::attometer_t<double>{1.0})},
        {"1 fm", std::format("{}", pkr::units::femtometer_t<double>{1.0})},
        {"1 pm", std::format("{}", pkr::units::picometer_t<double>{1.0})},
        {"1 nm", std::format("{}", pkr::units::nanometer_t<double>{1.0})},
        {"1 um", std::format("{}", pkr::units::micrometer_t<double>{1.0})},
        {"1 mm", std::format("{}", pkr::units::millimeter_t<double>{1.0})},
        {"1 cm", std::format("{}", pkr::units::centimeter_t<double>{1.0})},
        {"1 dm", std::format("{}", pkr::units::decimeter_t<double>{1.0})},
        {"1 m", std::format("{}", pkr::units::meter_t<double>{1.0})},
        {"1 dam", std::format("{}", pkr::units::decameter_t<double>{1.0})},
        {"1 hm", std::format("{}", pkr::units::hectometer_t<double>{1.0})},
        {"1 km", std::format("{}", pkr::units::kilometer_t<double>{1.0})},
        {"1 Mm", std::format("{}", pkr::units::megameter_t<double>{1.0})},
        {"1 Gm", std::format("{}", pkr::units::gigameter_t<double>{1.0})},
    };
...
{
    pkr::units::kilometer_t<double> distance{42.195};
...
{
    pkr::units::meter_t<double> width{3.2};
    pkr::units::meter_t<double> depth{2.5};
    pkr::units::meter_t<double> height{1.75};
...
{
    pkr::units::meter_t<double> m{1e-15};
    std::string result = std::format("{:e}", m);
...
{
    pkr::units::kilometer_t<double> km{1e15};
...
{
    pkr::units::meter_t<double> m{1.0 / 3.0};
