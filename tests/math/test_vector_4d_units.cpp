...
{
    pkr::units::vec_4d_units_t<pkr::units::meter_t> v{
        pkr::units::meter_t{1.0}, 
        pkr::units::meter_t{2.0}, 
        pkr::units::meter_t{3.0}, 
        pkr::units::meter_t{4.0}
    };
...
{
    pkr::units::vec_4d_units_t<pkr::units::meter_t> v1{
        pkr::units::meter_t{1.0}, 
        pkr::units::meter_t{2.0}, 
        pkr::units::meter_t{3.0}, 
        pkr::units::meter_t{4.0}
    };
    pkr::units::vec_4d_units_t<pkr::units::meter_t> v2{
        pkr::units::meter_t{0.5}, 
        pkr::units::meter_t{1.5}, 
        pkr::units::meter_t{2.5}, 
        pkr::units::meter_t{3.5}
    };
    auto result = v1 + v2;
...
TEST_F(Vector4DUnitsTest, scalar_division)
{
    pkr::units::vec_4d_units_t<pkr::units::meter_t> v{
        pkr::units::meter_t{2.0}, 
        pkr::units::meter_t{4.0}, 
        pkr::units::meter_t{6.0}, 
        pkr::units::meter_t{8.0}
    };
    auto result = v / 2.0;
...
TEST_F(Vector4DUnitsTest, equality)
{
    ...
    pkr::units::vec_4d_units_t<pkr::units::meter_t> v3{
        pkr::units::meter_t{1.1}, 
        pkr::units::meter_t{2.0}, 
        pkr::units::meter_t{3.0}, 
        pkr::units::meter_t{4.0}
    };
...
TEST_F(Vector4DUnitsTest, ratio_preservation_km_addition)
{
    ...
    pkr::units::vec_4d_units_t<pkr::units::kilometer_t> v1{
        pkr::units::kilometer_t{1.0}, 
        pkr::units::kilometer_t{2.0}, 
        pkr::units::kilometer_t{3.0}, 
        pkr::units::kilometer_t{4.0}
    };
    pkr::units::vec_4d_units_t<pkr::units::kilometer_t> v2{
        pkr::units::kilometer_t{0.5}, 
        pkr::units::kilometer_t{1.5}, 
        pkr::units::kilometer_t{2.5}, 
        pkr::units::kilometer_t{3.5}
    };
    auto result = v1 + v2;
...
TEST_F(Vector4DUnitsTest, ratio_preservation_km_add_meter)
{
    ...
    pkr::units::vec_4d_units_t<pkr::units::meter_t> v_m{
        pkr::units::meter_t{500.0}, 
        pkr::units::meter_t{1000.0}, 
        pkr::units::meter_t{1500.0}, 
        pkr::units::meter_t{2000.0}
    };
