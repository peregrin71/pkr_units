...
{
    pkr::units::vec_3d_t<pkr::units::meter_t<double>> v{pkr::units::meter_t<double>{1.0}, pkr::units::meter_t<double>{2.0}, pkr::units::meter_t<double>{3.0}};
...
{
    pkr::units::vec_3d_t<pkr::units::meter_t<double>> v1{pkr::units::meter_t<double>{1.0}, pkr::units::meter_t<double>{2.0}, pkr::units::meter_t<double>{3.0}};
    pkr::units::vec_3d_t<pkr::units::meter_t<double>> v2{pkr::units::meter_t<double>{0.5}, pkr::units::meter_t<double>{1.5}, pkr::units::meter_t<double>{2.5}};
    auto result = v1 + v2;
...
{
    pkr::units::vec_3d_t<pkr::units::meter_t<double>> v{pkr::units::meter_t<double>{2.0}, pkr::units::meter_t<double>{4.0}, pkr::units::meter_t<double>{6.0}};
    v /= 2.0;
