...
{
    pkr::units::vec_3d_t<pkr::units::kilometer_t> v1{
        pkr::units::kilometer_t{1.0}, pkr::units::kilometer_t{2.0}, pkr::units::kilometer_t{3.0}};
    pkr::units::vec_3d_t<pkr::units::kilometer_t> v2{
        pkr::units::kilometer_t{0.5}, pkr::units::kilometer_t{1.5}, pkr::units::kilometer_t{2.5}};
    auto result = v1 + v2;
...
{
    pkr::units::vec_3d_t<pkr::units::kilometer_t> v_km{
        pkr::units::kilometer_t{1.0}, pkr::units::kilometer_t{2.0}, pkr::units::kilometer_t{3.0}};
    pkr::units::vec_3d_t<pkr::units::meter_t> v_m{
        pkr::units::meter_t{500.0}, pkr::units::meter_t{1000.0}, pkr::units::meter_t{1500.0}};
