...
TEST_F(Vector4DMeasurementsRSSTest, construction)
{
    ...
    pkr::units::vec_4d_measurements_rss_t<meter_meas> v{meter_meas{1.0, 0.1}, meter_meas{2.0, 0.2}, meter_meas{3.0, 0.3}, meter_meas{4.0, 0.4}};
...
{
    using meter_meas = pkr::units::measurement_t<pkr::units::meter_t>;
    pkr::units::vec_4d_measurements_rss_t<meter_meas> v1{meter_meas{1.0, 0.1}, meter_meas{2.0, 0.2}, meter_meas{3.0, 0.3}, meter_meas{4.0, 0.4}};
    pkr::units::vec_4d_measurements_rss_t<meter_meas> v2{meter_meas{0.5, 0.05}, meter_meas{1.5, 0.15}, meter_meas{2.5, 0.25}, meter_meas{3.5, 0.35}};
    auto result = v1 + v2;
...
TEST_F(Vector4DMeasurementsRSSTest, measurement_scalar_multiplication)
{
    using meter_meas = pkr::units::measurement_t<pkr::units::meter_t>;
    pkr::units::vec_4d_measurements_rss_t<meter_meas> v{meter_meas{1.0, 0.1}, meter_meas{2.0, 0.2}, meter_meas{3.0, 0.3}, meter_meas{4.0, 0.4}};
    auto scalar = pkr::units::measurement_t<pkr::units::scalar_t>{2.0, 0.1};
...
{
    using meter_meas = pkr::units::measurement_t<pkr::units::meter_t>;
    pkr::units::vec_4d_measurements_rss_t<meter_meas> v{meter_meas{2.0, 0.1}, meter_meas{4.0, 0.2}, meter_meas{6.0, 0.3}, meter_meas{8.0, 0.4}};
    auto result = v / 2.0;
