...
TEST_F(MultiCastTest, cast_velocity_to_millimeter_per_second)
{
    ...
    auto mms = pkr::units::multi_unit_cast<pkr::units::millimeter_t<double>, pkr::units::per<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, cast_velocity_to_kilometer_per_second)
{
    ...
    auto kms = pkr::units::multi_unit_cast<pkr::units::kilometer_t<double>, pkr::units::per<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, cast_to_base_units_returns_ratio_one)
{
    ...
    auto base = pkr::units::multi_unit_cast_to_base_units<pkr::units::meter_t<double>, pkr::units::per<pkr::units::second_t<double>>>(kmh);
...
{
    // 1 m/s ~ 3.28084 ft/s
    pkr::units::meter_per_second_t<double> mps{1.0};

    auto fps = pkr::units::multi_unit_cast<pkr::units::foot_t<double>, pkr::units::per<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, cast_meter_per_second_to_miles_per_hour)
{
    ...
    auto mph = pkr::units::multi_unit_cast<pkr::units::mile_t<double>, pkr::units::per<pkr::units::hour_t<double>>>(mps);
...
TEST_F(MultiCastTest, cast_with_centimeter_numerator)
{
    ...
    auto cms = pkr::units::multi_unit_cast<pkr::units::centimeter_t<double>, pkr::units::per<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, cast_with_minute_denominator)
{
    ...
    auto mpm = pkr::units::multi_unit_cast<pkr::units::meter_t<double>, pkr::units::per<pkr::units::minute_t<double>>>(mps);
...
TEST_F(MultiCastTest, cast_with_millisecond_denominator)
{
    ...
    auto mms = pkr::units::multi_unit_cast<pkr::units::meter_t<double>, pkr::units::per<pkr::units::millisecond_t<double>>>(mps);
...
TEST_F(MultiCastTest, acceleration_meter_per_second_squared)
{
    ...
    pkr::units::meter_per_second_t<double> velocity{100.0};

    // Conceptual: acceleration should have dimension [length / time^2]
    // Using multi_unit_cast with per_unit_squared
    auto acceleration = pkr::units::multi_unit_cast<pkr::units::meter_t<double>, pkr::units::per_unit_squared<pkr::units::second_t<double>>>(velocity);
...
TEST_F(MultiCastTest, acceleration_kilometer_per_hour_squared)
{
    ...
    pkr::units::kilometer_per_hour_t<double> kmh{100.0};

    auto kmh_squared = pkr::units::multi_unit_cast<pkr::units::kilometer_t<double>, pkr::units::per_unit_squared<pkr::units::hour_t<double>>>(kmh);
...
TEST_F(MultiCastTest, cast_with_different_scales_numerator_and_denominator)
{
    ...
    auto cms_per_ms = pkr::units::multi_unit_cast<pkr::units::centimeter_t<double>, pkr::units::per<pkr::units::millisecond_t<double>>>(mps);
...
TEST_F(MultiCastTest, cast_kilometer_to_meter_per_second)
{
    ...
    pkr::units::kilometer_t<double> km{36.0}; // 36 km

    auto mps = pkr::units::multi_unit_cast<pkr::units::meter_t<double>, pkr::units::per<pkr::units::second_t<double>>>(km);
...
TEST_F(MultiCastTest, cast_with_two_denominator_units)
{
    ...
    pkr::units::meter_per_second_t<double> mps{2.0};

    auto per_second_meter = pkr::units::multi_unit_cast<pkr::units::meter_t<double>, pkr::units::per<pkr::units::second_t<double>, pkr::units::meter_t<double>>>(mps);
...
TEST_F(MultiCastTest, cast_with_integral_constant_power_denominator)
{
    ...
    pkr::units::meter_per_second_t<double> mps{3.0};

    auto per_second_squared =
        pkr::units::multi_unit_cast<pkr::units::meter_t<double>, pkr::units::per<pkr::units::second_t<double>, std::integral_constant<int, 2>, pkr::units::meter_t<double>>>(mps);
...
TEST_F(MultiCastTest, cast_with_integral_constant_negative_power_denominator)
{
    ...
    pkr::units::meter_per_second_t<double> mps{4.0};
...
TEST_F(MultiCastTest, specialized_template_per_unit_squared)
{
    ...
    pkr::units::meter_per_second_t<double> mps{100.0};

    auto m_per_s2 = pkr::units::multi_unit_cast<pkr::units::meter_t<double>, pkr::units::per_unit_squared<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, specialized_template_per_unit_cubed)
{
    ...
    auto m_per_s3 = pkr::units::multi_unit_cast<pkr::units::meter_t<double>, pkr::units::per_unit_cubed<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, specialized_template_per_unit_quartic)
{
    ...
    auto m_per_s4 = pkr::units::multi_unit_cast<pkr::units::meter_t<double>, pkr::units::per_unit_quartic<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, specialized_template_per_unit_inverse)
{
    ...
    auto m_times_s = pkr::units::multi_unit_cast<pkr::units::meter_t<double>, pkr::units::per_unit_inverse<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, specialized_template_per_unit_inverse_squared)
{
    ...
    auto m_times_s2 = pkr::units::multi_unit_cast<pkr::units::meter_t<double>, pkr::units::per_unit_inverse_squared<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, velocity_derived_unit_via_multi_cast)
{
    ...
    pkr::units::meter_per_second_t<double> mps{20.0};
...
TEST_F(MultiCastTest, torque_kilogram_meter_squared_per_second_squared)
{
    ...
    auto torque_like = pkr::units::multi_unit_cast<pkr::units::kilogram_t<double>, pkr::units::meter_t<double>, pkr::units::per_unit_squared<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, torque_gram_centimeter_squared_per_second_squared)
{
    ...
    auto torque_gram_cm2 = pkr::units::multi_unit_cast<pkr::units::gram_t<double>, pkr::units::centimeter_t<double>, pkr::units::per_unit_squared<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, torque_with_millisecond_cubed_denominator)
{
    ...
    auto complex_unit = pkr::units::multi_unit_cast<pkr::units::kilogram_t<double>, pkr::units::meter_t<double>, pkr::units::per_unit_cubed<pkr::units::millisecond_t<double>>>(mps);
...
TEST_F(MultiCastTest, two_numerators_meter_and_second)
{
    ...
    auto meter_times_second = pkr::units::multi_unit_cast<pkr::units::meter_t<double>, pkr::units::second_t<double>, pkr::units::per<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, two_numerators_kilogram_meter)
{
    ...
    auto kg_m_per_s = pkr::units::multi_unit_cast<pkr::units::kilogram_t<double>, pkr::units::meter_t<double>, pkr::units::per<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, two_numerators_scaled_units)
{
    ...
    auto kg_mm_per_s = pkr::units::multi_unit_cast<pkr::units::kilogram_t<double>, pkr::units::millimeter_t<double>, pkr::units::per<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, three_numerators_complex_dimension)
{
    ...
    pkr::units::meter_per_second_t<double> mps{15.0};

    auto complex_three =
        pkr::units::multi_unit_cast<pkr::units::kilogram_t<double>, pkr::units::meter_t<double>, pkr::units::second_t<double>, pkr::units::per_unit_squared<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, energy_like_unit_kilogram_meter_squared_per_second_squared)
{
    ...
    pkr::units::meter_per_second_t<double> mps{50.0};

    auto energy_unit = pkr::units::multi_unit_cast<pkr::units::kilogram_t<double>, pkr::units::meter_t<double>, pkr::units::per_unit_squared<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, power_unit_kilogram_meter_squared_per_second_cubed)
{
    ...
    auto power_unit = pkr::units::multi_unit_cast<pkr::units::kilogram_t<double>, pkr::units::meter_t<double>, pkr::units::per_unit_cubed<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, force_like_unit_kilogram_meter_per_second_squared)
{
    ...
    pkr::units::meter_per_second_t<double> mps{9.81};

    auto base_units =
        pkr::units::multi_unit_cast_to_base_units<pkr::units::kilogram_t<double>, pkr::units::meter_t<double>, pkr::units::per_unit_squared<pkr::units::second_t<double>>>(mps);
    auto force_unit =
        pkr::units::multi_unit_cast_to_derived<pkr::units::kilogram_t<double>, pkr::units::meter_t<double>, pkr::units::per_unit_squared<pkr::units::second_t<double>>>(mps);
    ...
    static_assert(std::is_same_v<decltype(force_unit), pkr::units::newton_t<double>>);
...
TEST_F(MultiCastTest, torque_gram_millimeter_squared_per_second_squared)
{
    ...
    auto torque_small = pkr::units::multi_unit_cast<pkr::units::gram_t<double>, pkr::units::millimeter_t<double>, pkr::units::per_unit_squared<pkr::units::second_t<double>>>(mps);
...
TEST_F(MultiCastTest, momentum_with_hour_denominator)
{
    ...
    auto kg_m_per_h = pkr::units::multi_unit_cast<pkr::units::kilogram_t<double>, pkr::units::meter_t<double>, pkr::units::per<pkr::units::hour_t<double>>>(mps);
