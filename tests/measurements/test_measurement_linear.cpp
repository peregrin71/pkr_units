...
TEST_F(MeasurementTest, construction_and_access)
{
    ...
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> length{5.0, 0.1};
...
{
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> len1{5.0, 0.1};
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> len2{3.0, 0.2};
...
{
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> len1{5.0, 0.1};
    pkr::units::measurement_lin_t<pkr::units::centimeter_t<double>> len2{300.0, 5.0}; // 3.0 m ± 0.05 m
...
{
    pkr::units::measurement_lin_t<pkr::units::second_t<double>> time1{10.0, 0.1};
    pkr::units::measurement_lin_t<pkr::units::second_t<double>> time2{3.0, 0.2};
...
{
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> length{5.0, 0.1}; // 2% relative uncertainty
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> width{3.0, 0.15}; // 5% relative uncertainty
...
{
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> distance{10.0, 0.2}; // 2% relative uncertainty
    pkr::units::measurement_lin_t<pkr::units::second_t<double>> time{2.0, 0.1};     // 5% relative uncertainty
...
TEST_F(MeasurementTest, velocity_calculation)
{
    ...
    pkr::units::measurement_lin_t<pkr::units::millimeter_t<double>> distance{5000.0, 50.0};

    // Time measurement
    pkr::units::measurement_lin_t<pkr::units::second_t<double>> time{2.5, 0.1};
...
{
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> length{10.0, 0.5};
...
{
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> len1{5.0, 0.1};
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> len2{5.0, 0.1};
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> len3{5.0, 0.2};
...
{
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> length{5.123456, 0.123456};
...
{
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> length{1.234567e6, 1.234567e4};
...
{
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> length{5.123, 0.456};
...
TEST_F(MeasurementTest, pow_integer_exponent_lin)
{
    // Test power function with fully correlated uncertainty
    // Measurement: x = 2.0 ± 0.1 m
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> measurement{2.0, 0.1};
    ...
    auto power_two = pkr::units::pow_lin<2>(measurement);
    ...
    auto power_three = pkr::units::pow_lin<3>(measurement);
    ...
    auto power_neg_one = pkr::units::pow_lin<-1>(measurement);
...
TEST_F(MeasurementTest, math_sin)
{
    ...
    pkr::units::measurement_lin_t<pkr::units::radian_t<double>> angle{0.0, 0.1}; // 0 ± 0.1 radians
...
TEST_F(MeasurementTest, math_tan)
{
    ...
    pkr::units::measurement_lin_t<pkr::units::radian_t<double>> angle{std::numbers::pi / 4.0, 0.05};
...
TEST_F(MeasurementTest, drag_force_calculation)
{
    ...
    pkr::units::measurement_lin_t<pkr::units::kilogram_per_cubic_meter_t<double>> density{1.225, 0.005};

    // Velocity: 30.0 ± 0.5 m/s
    pkr::units::measurement_lin_t<pkr::units::meter_per_second_t<double>> velocity{30.0, 0.5};

    // Drag coefficient: 0.30 ± 0.02 (dimensionless)
    pkr::units::measurement_lin_t<pkr::units::scalar_t<double>> drag_coefficient{0.30, 0.02};
    ...
    auto drag_force = pkr::units::measurement_lin_t<pkr::units::scalar_t<double>>{0.5, 0.0} * temp3;
...
{
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> length{0.0, 0.5};
...
{
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> length{0.0, 0.5};
    pkr::units::measurement_lin_t<pkr::units::meter_t<double>> width{3.0, 0.15};
