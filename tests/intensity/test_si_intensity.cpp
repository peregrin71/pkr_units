...
{
    pkr::units::candela_t<double> cd{5.0};
...
{
    pkr::units::candela_t<double> cd1{5.0};
    pkr::units::candela_t<double> cd2 = cd1;
...
{
    pkr::units::candela_t<double> cd1{5.0};
    pkr::units::candela_t<double> cd2 = std::move(cd1);
    ASSERT_DOUBLE_EQ(cd2.value(), 5.0);
}
...
{
    pkr::units::candela_t<double> cd1{5.0};
    pkr::units::candela_t<double> cd2{0.0};
    cd2 = cd1;
    ASSERT_DOUBLE_EQ(cd2.value(), 5.0);
}
...
{
    pkr::units::candela_t<double> cd1{3.0};
    pkr::units::candela_t<double> cd2{2.0};
    auto result = cd1 + cd2;
...
{
    pkr::units::millicandela_t<double> mcd1{500.0};
    pkr::units::millicandela_t<double> mcd2{250.0};
...
{
    pkr::units::millicandela_t<double> mcd1{750.0};
    pkr::units::millicandela_t<double> mcd2{250.0};
    auto result = mcd1 - mcd2;
...
{
    pkr::units::candela_t<double> cd{1.0};
    pkr::units::millicandela_t<double> mcd{500.0};
    auto result = cd + mcd;
...
{
    pkr::units::millicandela_t<double> mcd{1500.0};
    pkr::units::candela_t<double> cd{1.0};
    auto result = mcd - cd;
    // Result is in LHS type (millicandela)
...
{
    pkr::units::candela_t<double> cd{2.0};
    pkr::units::millicandela_t<double> mcd{500.0};
    auto result = cd - mcd;
    // Result is in LHS type (candela)
    // 2cd - 0.5cd = 1.5cd
...
{
    pkr::units::candela_t<double> cd{6.0};
    auto result = cd / 2.0;
    ASSERT_DOUBLE_EQ(result.value(), 3.0);
}
...
{
    pkr::units::millicandela_t<double> mcd{100.0};
    auto result = mcd * 5.0;
    ASSERT_DOUBLE_EQ(result.value(), 500.0);
}
...
{
    pkr::units::candela_t<double> cd1{2.0};
    pkr::units::candela_t<double> cd2{3.0};
    auto result = cd1 * cd2;
...
{
    pkr::units::candela_t<double> cd1{10.0};
    pkr::units::candela_t<double> cd2{2.0};
    auto result = cd1 / cd2;
...
{
    pkr::units::millicandela_t<double> mcd1{500.0};
    pkr::units::millicandela_t<double> mcd2{100.0};
    auto result = mcd1 / mcd2;
...
{
    constexpr pkr::units::candela_t<double> cd1{3.0};
    constexpr pkr::units::candela_t<double> cd2{2.0};
...
{
    constexpr pkr::units::candela_t<double> cd{2.0};
...
{
    pkr::units::nanocandela_t<double> ncd{0.001};
    ASSERT_DOUBLE_EQ(ncd.value(), 0.001);
}

TEST_F(SiIntensityTest, very_large_intensity_values)
{
    pkr::units::kilocandela_t<double> kcd{1000000.0};
    ASSERT_DOUBLE_EQ(kcd.value(), 1000000.0);
}

TEST_F(SiIntensityTest, add_very_different_scales)
{
    pkr::units::millicandela_t<double> mcd{1.0}; // 1 millicandela
    pkr::units::candela_t<double> cd{1.0};       // 1 candela = 1000 mcd
    auto result = mcd + cd;
    // Result is in LHS type (millicandela)
...
{
    pkr::units::candela_t<double> cd1{1.0};
    pkr::units::candela_t<double> cd2{3.0};
    auto result = cd1 - cd2;
