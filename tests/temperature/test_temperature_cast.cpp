...
{
    pkr::units::celsius_t<double> c{20.0};
    pkr::units::kelvin_t<double> k = pkr::units::unit_cast<pkr::units::kelvin_t<double>>(c);
    EXPECT_DOUBLE_EQ(k.value(), 293.15);
}

TEST_F(TemperatureCastTest, CelsiusZeroToKelvin)
{
    pkr::units::celsius_t<double> c{0.0};
    pkr::units::kelvin_t<double> k = pkr::units::unit_cast<pkr::units::kelvin_t<double>>(c);
...
{
    pkr::units::celsius_t<double> c{-10.0};
    pkr::units::kelvin_t<double> k = pkr::units::unit_cast<pkr::units::kelvin_t<double>>(c);
...
{
    pkr::units::kelvin_t<double> k{293.15};
    pkr::units::celsius_t<double> c = pkr::units::unit_cast<pkr::units::celsius_t<double>>(k);
...
{
    pkr::units::fahrenheit_t<double> f{32.0};
    pkr::units::celsius_t<double> c = pkr::units::unit_cast<pkr::units::celsius_t<double>>(f);
    EXPECT_DOUBLE_EQ(c.value(), 0.0);
}

TEST_F(TemperatureCastTest, FahrenheitToCelsius212)
{
    pkr::units::fahrenheit_t<double> f{212.0};
    pkr::units::celsius_t<double> c = pkr::units::unit_cast<pkr::units::celsius_t<double>>(f);
...
{
    pkr::units::fahrenheit_t<double> f{98.6};
    pkr::units::celsius_t<double> c = pkr::units::unit_cast<pkr::units::celsius_t<double>>(f);
...
{
    pkr::units::celsius_t<double> c{0.0};
    pkr::units::fahrenheit_t<double> f = pkr::units::unit_cast<pkr::units::fahrenheit_t<double>>(c);
    EXPECT_DOUBLE_EQ(f.value(), 32.0);
}

TEST_F(TemperatureCastTest, CelsiusToFahrenheit100)
{
    pkr::units::celsius_t<double> c{100.0};
    pkr::units::fahrenheit_t<double> f = pkr::units::unit_cast<pkr::units::fahrenheit_t<double>>(c);
...
{
    pkr::units::celsius_t<double> c{37.0};
    pkr::units::fahrenheit_t<double> f = pkr::units::unit_cast<pkr::units::fahrenheit_t<double>>(c);
...
{
    pkr::units::fahrenheit_t<double> f{32.0};
    pkr::units::kelvin_t<double> k = pkr::units::unit_cast<pkr::units::kelvin_t<double>>(f);
    EXPECT_DOUBLE_EQ(k.value(), 273.15);
}
...
{
    pkr::units::kelvin_t<double> k{273.15};
    pkr::units::fahrenheit_t<double> f = pkr::units::unit_cast<pkr::units::fahrenheit_t<double>>(k);
    EXPECT_DOUBLE_EQ(f.value(), 32.0);
}

TEST_F(TemperatureCastTest, KelvinToFahrenheit373_15)
{
    pkr::units::kelvin_t<double> k{373.15};
    pkr::units::fahrenheit_t<double> f = pkr::units::unit_cast<pkr::units::fahrenheit_t<double>>(k);
    EXPECT_DOUBLE_EQ(f.value(), 212.0);
}
...
{
    pkr::units::celsius_t<double> original{25.5};
    pkr::units::kelvin_t<double> k = pkr::units::unit_cast<pkr::units::kelvin_t<double>>(original);
    pkr::units::celsius_t<double> back = pkr::units::unit_cast<pkr::units::celsius_t<double>>(k);
    EXPECT_DOUBLE_EQ(back.value(), original.value());
}

TEST_F(TemperatureCastTest, RoundTripFahrenheitCelsius)
{
    pkr::units::fahrenheit_t<double> original{77.0};
    pkr::units::celsius_t<double> c = pkr::units::unit_cast<pkr::units::celsius_t<double>>(original);
    pkr::units::fahrenheit_t<double> back = pkr::units::unit_cast<pkr::units::fahrenheit_t<double>>(c);
    EXPECT_DOUBLE_EQ(back.value(), original.value());
}

TEST_F(TemperatureCastTest, RoundTripKelvinFahrenheit)
{
    pkr::units::kelvin_t<double> original{300.0};
    pkr::units::fahrenheit_t<double> f = pkr::units::unit_cast<pkr::units::fahrenheit_t<double>>(original);
    pkr::units::kelvin_t<double> back = pkr::units::unit_cast<pkr::units::kelvin_t<double>>(f);
    EXPECT_DOUBLE_EQ(back.value(), original.value());
}
...
{
    // Very cold
    pkr::units::kelvin_t<double> very_cold{1.0};
    pkr::units::celsius_t<double> c_cold = pkr::units::unit_cast<pkr::units::celsius_t<double>>(very_cold);
    EXPECT_DOUBLE_EQ(c_cold.value(), -272.15);

    // Very hot
    pkr::units::celsius_t<double> very_hot{10000.0};
    pkr::units::kelvin_t<double> k_hot = pkr::units::unit_cast<pkr::units::kelvin_t<double>>(very_hot);
