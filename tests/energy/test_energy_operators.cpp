...
{
    pkr::units::joule_t energy1{500.0};
    pkr::units::joule_t energy2{300.0};
...
{
    pkr::units::joule_t energy1{1000.0};
    pkr::units::joule_t energy2{1000.0};
...
{
    pkr::units::joule_t energy1{1000.0};
    pkr::units::joule_t energy2{500.0};
    ASSERT_TRUE(energy1 != energy2);
}
...
TEST_F(EnergyOperatorsTest, less_than_or_equal_energies)
{
    ...
    pkr::units::joule_t energy2{500.0};
    ASSERT_TRUE(energy1 <= energy2);
    pkr::units::joule_t energy3{300.0};
...
TEST_F(EnergyOperatorsTest, greater_than_or_equal_energies)
{
    ...
    pkr::units::joule_t energy2{500.0};
    ASSERT_TRUE(energy1 >= energy2);
    pkr::units::joule_t energy3{700.0};
    ASSERT_TRUE(energy3 >= energy1);
}

TEST_F(EnergyOperatorsTest, constexpr_energy_addition)
{
    constexpr pkr::units::joule_t energy1{500.0};
    constexpr pkr::units::joule_t energy2{300.0};
...
{
    constexpr pkr::units::joule_t energy{1000.0};
...
{
    pkr::units::joule_t energy{500.0};
    energy += pkr::units::joule_t{300.0};
