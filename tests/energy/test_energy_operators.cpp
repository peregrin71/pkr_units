...
{
    pkr::units::joule energy1{500.0};
    pkr::units::joule energy2{300.0};
...
{
    pkr::units::joule energy{1000.0};
    EXPECT_THROW(energy / 0.0, std::runtime_error);
}
...
{
    pkr::units::joule energy1{1000.0};
    pkr::units::joule energy2{1000.0};
...
TEST_F(EnergyOperatorsTest, greater_than_or_equal_energies)
{
    ...
    pkr::units::joule energy2{500.0};
    ASSERT_TRUE(energy1 >= energy2);
    pkr::units::joule energy3{700.0};
    ASSERT_TRUE(energy3 >= energy1);
}

TEST_F(EnergyOperatorsTest, constexpr_energy_addition)
{
    constexpr pkr::units::joule energy1{500.0};
    constexpr pkr::units::joule energy2{300.0};
...
{
    constexpr pkr::units::joule energy{1000.0};
