...
TEST_F(ForceTest, copy_constructor)
{
    ...
    pkr::units::newton force2{force1};
...
{
    pkr::units::newton force1{100.0};
    pkr::units::newton force2{std::move(force1)};
    ASSERT_DOUBLE_EQ(force2.value(), 100.0);
}
