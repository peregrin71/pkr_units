...
{
    pkr::units::kilonewton_t force{5.0};
...
TEST_F(ForceTest, copy_constructor)
{
    ...
    pkr::units::newton_t force2{force1};
...
{
    pkr::units::newton_t force1{100.0};
    pkr::units::newton_t force2{std::move(force1)};
    ASSERT_DOUBLE_EQ(force2.value(), 100.0);
}
