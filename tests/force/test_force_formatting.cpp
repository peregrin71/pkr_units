...
{
    pkr::units::newton force{123.456789};
...
{
    pkr::units::kilonewton force{5.5};
    std::string result = std::format("{}", force);
...
{
    pkr::units::millinewton force{500.0};
    std::string result = std::format("{}", force);
...
{
    pkr::units::micronewton force{1000.0};
    std::string result = std::format("{}", force);
...
{
    pkr::units::nanonewton force{5000000.0};
    std::string result = std::format("{}", force);
...
{
    pkr::units::newton force{3.141592653589793};
    std::string result = std::format("{}", force);
...
{
    pkr::units::newton force{123.456};
    std::string result = std::format("{}", force);
