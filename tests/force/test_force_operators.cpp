...
{
    pkr::units::newton_t<double> force1{50.0};
    pkr::units::newton_t<double> force2{30.0};
...
{
    pkr::units::newton_t<double> force1{100.0};
    pkr::units::newton_t<double> force2{100.0};
...
{
    pkr::units::newton_t<double> force1{100.0};
    pkr::units::newton_t<double> force2{50.0};
    ASSERT_TRUE(force1 != force2);
}
...
TEST_F(ForceOperatorsTest, less_than_or_equal_forces)
{
    ...
    pkr::units::newton_t<double> force2{50.0};
    ASSERT_TRUE(force1 <= force2);
    pkr::units::newton_t<double> force3{30.0};
...
TEST_F(ForceOperatorsTest, greater_than_or_equal_forces)
{
    ...
    pkr::units::newton_t<double> force2{50.0};
    ASSERT_TRUE(force1 >= force2);
    pkr::units::newton_t<double> force3{70.0};
    ASSERT_TRUE(force3 >= force1);
}

TEST_F(ForceOperatorsTest, constexpr_force_addition)
{
    constexpr pkr::units::newton_t<double> force1{50.0};
    constexpr pkr::units::newton_t<double> force2{30.0};
...
{
    constexpr pkr::units::newton_t<double> force{100.0};
...
{
    pkr::units::newton_t<double> force{50.0};
    force += pkr::units::newton_t<double>{30.0};
