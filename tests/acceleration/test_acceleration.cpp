...
{
    pkr::units::meter_per_second_squared_t<double> accel{9.81};
...
{
    pkr::units::meter_per_second_squared_t<double> accel{0.0};
...
TEST_F(AccelerationTest, copy_constructor)
{
    ...
    pkr::units::meter_per_second_squared_t<double> accel2{accel1};
...
{
    pkr::units::meter_per_second_squared_t<double> accel1{9.81};
    pkr::units::meter_per_second_squared_t<double> accel2{std::move(accel1)};
    ASSERT_DOUBLE_EQ(accel2.value(), 9.81);
}
...
{
    pkr::units::meter_per_second_squared_t<double> accel1{9.81};
    pkr::units::meter_per_second_squared_t<double> accel2{0.0};
    accel2 = accel1;
    ASSERT_DOUBLE_EQ(accel2.value(), 9.81);
}
...
{
    pkr::units::meter_per_second_squared_t<double> accel{1.0};
...
{
    pkr::units::meter_per_second_squared_t<double> accel{1e-10};
    ASSERT_DOUBLE_EQ(accel.value(), 1e-10);
}

TEST_F(AccelerationTest, very_large_values)
{
    pkr::units::meter_per_second_squared_t<double> accel{1e10};
