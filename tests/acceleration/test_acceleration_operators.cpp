...
{
    pkr::units::meter_per_second_squared_t<double> accel1{5.0};
    pkr::units::meter_per_second_squared_t<double> accel2{3.0};
...
{
    pkr::units::meter_per_second_squared_t<double> accel1{10.0};
    pkr::units::meter_per_second_squared_t<double> accel2{3.0};
    auto result = accel1 - accel2;
...
{
    pkr::units::meter_per_second_squared_t<double> accel{5.0};
...
{
    pkr::units::meter_per_second_squared_t<double> accel{10.0};
    auto result = accel / 2.0;
...
{
    pkr::units::meter_per_second_squared_t<double> accel1{9.81};
    pkr::units::meter_per_second_squared_t<double> accel2{9.81};
...
{
    pkr::units::meter_per_second_squared_t<double> accel1{9.81};
    pkr::units::meter_per_second_squared_t<double> accel2{10.0};
    ASSERT_TRUE(accel1 != accel2);
}
...
{
    pkr::units::meter_per_second_squared_t<double> accel1{5.0};
    pkr::units::meter_per_second_squared_t<double> accel2{5.0};
    ASSERT_TRUE(accel1 <= accel2);
    pkr::units::meter_per_second_squared_t<double> accel3{3.0};
...
TEST_F(AccelerationOperatorsTest, greater_than_or_equal_accelerations)
{
    ...
    pkr::units::meter_per_second_squared_t<double> accel2{5.0};
    ASSERT_TRUE(accel1 >= accel2);
    pkr::units::meter_per_second_squared_t<double> accel3{7.0};
    ASSERT_TRUE(accel3 >= accel1);
}

TEST_F(AccelerationOperatorsTest, constexpr_acceleration_addition)
{
    constexpr pkr::units::meter_per_second_squared_t<double> accel1{5.0};
    constexpr pkr::units::meter_per_second_squared_t<double> accel2{3.0};
...
{
    constexpr pkr::units::meter_per_second_squared_t<double> accel{10.0};
...
{
    pkr::units::meter_per_second_squared_t<double> accel{5.0};
    accel += pkr::units::meter_per_second_squared_t<double>{3.0};
