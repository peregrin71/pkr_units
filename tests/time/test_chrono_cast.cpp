...
TEST_F(ChronoCastTest, chrono_seconds_to_second_t)
{
    ...
    auto pkr_secs = pkr::units::unit_cast<pkr::units::second_t<double>>(chrono_secs);
...
TEST_F(ChronoCastTest, chrono_milliseconds_to_millisecond_t)
{
    ...
    auto pkr_ms = pkr::units::unit_cast<pkr::units::millisecond_t<double>>(chrono_ms);
...
TEST_F(ChronoCastTest, chrono_microseconds_to_microsecond_t)
{
    ...
    auto pkr_us = pkr::units::unit_cast<pkr::units::microsecond_t<double>>(chrono_us);
...
TEST_F(ChronoCastTest, chrono_nanoseconds_to_nanosecond_t)
{
    ...
    auto pkr_ns = pkr::units::unit_cast<pkr::units::nanosecond_t<double>>(chrono_ns);
...
TEST_F(ChronoCastTest, chrono_minutes_to_second_t)
{
    ...
    auto pkr_secs = pkr::units::unit_cast<pkr::units::second_t<double>>(chrono_mins);
...
TEST_F(ChronoCastTest, chrono_hours_to_second_t)
{
    ...
    auto pkr_secs = pkr::units::unit_cast<pkr::units::second_t<double>>(chrono_hours);
...
TEST_F(ChronoCastTest, chrono_custom_duration_to_second_t)
{
    ...
    auto pkr_secs = pkr::units::unit_cast<pkr::units::second_t<double>>(chrono_custom);
...
{
    pkr::units::second_t<double> pkr_secs{3600.0};
...
{
    pkr::units::second_t<double> pkr_secs{120.0};
...
{
    pkr::units::hour_t<double> pkr_hours{3.0};
...
TEST_F(ChronoCastTest, second_t_to_chrono_custom_duration)
{
    // Custom duration: 10 seconds per tick
    using ten_second_duration = std::chrono::duration<long long, std::ratio<10, 1>>;
    pkr::units::second_t<double> pkr_secs{50.0}; // 5 ticks of 10 seconds
...
TEST_F(ChronoCastTest, round_trip_chrono_hours_to_pkr_seconds)
{
    ...
    auto pkr_secs = pkr::units::unit_cast<pkr::units::second_t<double>>(original_chrono);
...
{
    pkr::units::hour_t<double> original_pkr{2.0};

    auto chrono_secs = pkr::units::unit_cast<std::chrono::seconds>(original_pkr);
    auto back_to_pkr = pkr::units::unit_cast<pkr::units::hour_t<double>>(chrono_secs);
...
TEST_F(ChronoCastTest, complex_conversion_chain)
{
    ...
    auto pkr_ms = pkr::units::unit_cast<pkr::units::millisecond_t<double>>(chrono_mins);
    ...
    auto pkr_secs = pkr::units::unit_cast<pkr::units::second_t<double>>(chrono_us);
...
TEST_F(ChronoCastTest, round_trip_seconds)
{
    ...
    auto pkr_unit = pkr::units::unit_cast<pkr::units::second_t<double>>(original_chrono);
...
TEST_F(ChronoCastTest, round_trip_milliseconds)
{
    ...
    auto pkr_unit = pkr::units::unit_cast<pkr::units::millisecond_t<double>>(original_chrono);
...
TEST_F(ChronoCastTest, round_trip_different_units)
{
    ...
    auto pkr_ms = pkr::units::unit_cast<pkr::units::millisecond_t<double>>(original_chrono);
...
{
    pkr::units::second_t<double> pkr_secs{2.5};
...
TEST_F(ChronoCastTest, constexpr_chrono_seconds_to_second_t)
{
    ...
    constexpr auto pkr_secs = pkr::units::unit_cast<pkr::units::second_t<double>>(chrono_secs);
...
{
    constexpr pkr::units::second_t<double> pkr_secs{10.0};
...
TEST_F(ChronoCastTest, constexpr_chrono_hours_to_hour_t)
{
    ...
    constexpr auto pkr_hours = pkr::units::unit_cast<pkr::units::hour_t<double>>(chrono_hours);
...
{
    constexpr pkr::units::hour_t<double> pkr_hours{2.0};
