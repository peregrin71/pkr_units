...
3. Register them with the `most_derived_unit_type` pattern for automatic type deduction
...
template<>
struct details::most_derived_unit_type<double, std::ratio<1, 1>, angular_velocity_dimension>
{
    using type = radians_per_second_t;
};

template<>
struct details::most_derived_unit_type<double, std::ratio<628318530, 60000000000>, angular_velocity_dimension>
{
    using type = rpm_t;
};

template<>
struct details::most_derived_unit_type<double, std::ratio<1745329, 100000000>, angular_velocity_dimension>
{
...
### 3. **The most_derived_unit_type Specialization (CRITICAL!)**

This is what enables automatic type deduction in scalar operations:

```cpp
template<>
struct details::most_derived_unit_type<double, std::ratio<num, denom>, my_dimension>
{
...
template<>
struct details::most_derived_unit_type<float, std::ratio<628318530, 60000000000>, angular_velocity_dimension>
{
...
**❌ Forgetting the most_derived_unit_type specialization**
...
3. A `most_derived_unit_type` specialization (for type deduction)
