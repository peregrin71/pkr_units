...
// ============================================================================
// ASCII Formatter for Mass Units (char / std::string)
// ============================================================================

template<typename type_t, typename ratio_t>
requires std::is_same_v<typename si::unit_t<type_t, ratio_t, si::mass_dimension>::dimension_type, si::mass_dimension>
struct formatter<si::unit_t<type_t, ratio_t, si::mass_dimension>, char>
{
    ...
    auto format(const si::unit_t<type_t, ratio_t, si::mass_dimension>& unit, FormatContext& ctx) const
    {
        ...
        return std::format_to(out, " {}g", prefix);
    }
...
// ============================================================================
// Unicode Formatter for Mass Units (char8_t / std::u8string)
// ============================================================================

template<typename type_t, typename ratio_t>
requires std::is_same_v<typename si::unit_t<type_t, ratio_t, si::mass_dimension>::dimension_type, si::mass_dimension>
struct formatter<si::unit_t<type_t, ratio_t, si::mass_dimension>, char8_t>
{
    ...
    auto format(const si::unit_t<type_t, ratio_t, si::mass_dimension>& unit, FormatContext& ctx) const
    {
        ...
        return std::format_to(out, u8" {}g", prefix);
    }
...
// ============================================================================
// Wide Character Formatter for Mass Units (wchar_t / std::wstring)
// ============================================================================

template<typename type_t, typename ratio_t>
requires std::is_same_v<typename si::unit_t<type_t, ratio_t, si::mass_dimension>::dimension_type, si::mass_dimension>
struct formatter<si::unit_t<type_t, ratio_t, si::mass_dimension>, wchar_t>
{
    ...
    auto format(const si::unit_t<type_t, ratio_t, si::mass_dimension>& unit, FormatContext& ctx) const
    {
        ...
        return std::format_to(out, L" {}g", prefix);
    }
