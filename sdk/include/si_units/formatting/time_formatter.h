...
// ============================================================================
// ASCII Formatter for Time Units (char / std::string)
// ============================================================================

template<typename type_t, typename ratio_t>
requires std::is_same_v<typename si::unit_t<type_t, ratio_t, si::time_dimension>::dimension_type, si::time_dimension>
struct formatter<si::unit_t<type_t, ratio_t, si::time_dimension>, char>
{
    ...
    auto format(const si::unit_t<type_t, ratio_t, si::time_dimension>& unit, FormatContext& ctx) const
    {
        ...
        return std::format_to(out, " {}s", prefix);
    }
...
// ============================================================================
// Unicode Formatter for Time Units (char8_t / std::u8string)
// ============================================================================

template<typename type_t, typename ratio_t>
requires std::is_same_v<typename si::unit_t<type_t, ratio_t, si::time_dimension>::dimension_type, si::time_dimension>
struct formatter<si::unit_t<type_t, ratio_t, si::time_dimension>, char8_t>
{
    ...
    auto format(const si::unit_t<type_t, ratio_t, si::time_dimension>& unit, FormatContext& ctx) const
    {
        ...
        return std::format_to(out, u8" {}s", prefix);
    }
...
// ============================================================================
// Wide Character Formatter for Time Units (wchar_t / std::wstring)
// ============================================================================

template<typename type_t, typename ratio_t>
requires std::is_same_v<typename si::unit_t<type_t, ratio_t, si::time_dimension>::dimension_type, si::time_dimension>
struct formatter<si::unit_t<type_t, ratio_t, si::time_dimension>, wchar_t>
{
    ...
    auto format(const si::unit_t<type_t, ratio_t, si::time_dimension>& unit, FormatContext& ctx) const
    {
        ...
        return std::format_to(out, L" {}s", prefix);
    }
