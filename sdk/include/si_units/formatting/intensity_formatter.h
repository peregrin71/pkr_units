...
// ============================================================================
// ASCII Formatter for Luminous Intensity Units (char / std::string)
// ============================================================================

template<typename type_t, typename ratio_t>
requires std::is_same_v<typename si::unit_t<type_t, ratio_t, si::intensity_dimension>::dimension_type, si::intensity_dimension>
struct formatter<si::unit_t<type_t, ratio_t, si::intensity_dimension>, char>
{
    ...
    auto format(const si::unit_t<type_t, ratio_t, si::intensity_dimension>& unit, FormatContext& ctx) const
    {
        auto out = m_value_formatter.format(unit.value(), ctx);
        auto prefix = get_ascii_prefix<ratio_t>();
        return std::format_to(out, " {}cd", prefix);
    }
...
// ============================================================================
// Unicode Formatter for Luminous Intensity Units (char8_t / std::u8string)
// ============================================================================

template<typename type_t, typename ratio_t>
requires std::is_same_v<typename si::unit_t<type_t, ratio_t, si::intensity_dimension>::dimension_type, si::intensity_dimension>
struct formatter<si::unit_t<type_t, ratio_t, si::intensity_dimension>, char8_t>
{
    ...
    auto format(const si::unit_t<type_t, ratio_t, si::intensity_dimension>& unit, FormatContext& ctx) const
    {
        ...
        return std::format_to(out, u8" {}cd", prefix);
    }
...
// ============================================================================
// Wide Character Formatter for Luminous Intensity Units (wchar_t / std::wstring)
// ============================================================================

template<typename type_t, typename ratio_t>
requires std::is_same_v<typename si::unit_t<type_t, ratio_t, si::intensity_dimension>::dimension_type, si::intensity_dimension>
struct formatter<si::unit_t<type_t, ratio_t, si::intensity_dimension>, wchar_t>
{
    ...
    auto format(const si::unit_t<type_t, ratio_t, si::intensity_dimension>& unit, FormatContext& ctx) const
    {
        ...
        return std::format_to(out, L" {}cd", prefix);
    }
