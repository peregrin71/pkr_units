...
// Specialization for vec_4d_units_t - formats as [x, y, z, w] unit
...
struct formatter<PKR_UNITS_NAMESPACE::vec_4d_units_t<T>, CharT>
{
    ...
    auto format(const PKR_UNITS_NAMESPACE::vec_4d_units_t<T>& vec, FormatContext& ctx) const
    {
        auto out = ctx.out();
        ...
        *out++ = static_cast<CharT>('[');
        ...
        // Format w
        out = PKR_UNITS_NAMESPACE::impl::vector_formatting::format_component(ctx, format_spec, vec.w.value());
