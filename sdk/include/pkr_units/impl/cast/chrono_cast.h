...
requires std::is_base_of_v<typename target_unit_t::_base, target_unit_t> &&
    (details::is_pkr_unit<target_unit_t>::value_dimension == time_dimension) constexpr target_unit_t unit_cast(std::chrono::duration<Rep, Period> d) noexcept
{
...
requires std::is_base_of_v<typename source_unit_t::_base, source_unit_t> &&
    (details::is_pkr_unit<source_unit_t>::value_dimension == time_dimension) constexpr Duration unit_cast(const source_unit_t& source) noexcept
{
