...
namespace details
{
    ...
    constexpr type_t compute_conversion_factor(long long source_num, long long source_den,
                                               long long target_num, long long target_den) noexcept
    {
    ...
    constexpr unit_t<type_t, target_ratio_t, dim_v> unit_cast_impl(const unit_t<type_t, source_ratio_t, dim_v>& source) noexcept
    {
        ...
        else
        {
            ...
            constexpr type_t conversion_factor = compute_conversion_factor<type_t>(
...
template<typename target_type_t, typename target_ratio_t, dimension_t target_dim_v,
         typename source_type_t, typename source_ratio_t, dimension_t source_dim_v>
