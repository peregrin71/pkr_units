...
template<>
inline constexpr std::basic_string_view<char> base_unit_symbols<char>[] = {
    "m", "kg", "s", "A", "K", "mol", "cd", "rad"
};

// Specialization for wchar_t
template<>
inline constexpr std::basic_string_view<wchar_t> base_unit_symbols<wchar_t>[] = {
    L"m", L"kg", L"s", L"A", L"K", L"mol", L"cd", L"rad"
};

// Specialization for char8_t
template<>
inline constexpr std::basic_string_view<char8_t> base_unit_symbols<char8_t>[] = {
    u8"m", u8"kg", u8"s", u8"A", u8"K", u8"mol", u8"cd", u8"rad"
};
