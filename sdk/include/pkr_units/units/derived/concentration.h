...
struct kilogram_per_cubic_meter_t final : public details::unit_t<double, std::ratio<1, 1>, mass_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1, 1>, mass_concentration_v>;
    using _base::_base;
...
struct gram_per_cubic_meter_t final : public details::unit_t<double, std::ratio<1, 1000>, mass_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1, 1000>, mass_concentration_v>;
    using _base::_base;
...
struct gram_per_liter_t final : public details::unit_t<double, std::ratio<1, 1>, mass_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1, 1>, mass_concentration_v>;
    using _base::_base;
...
struct milligram_per_liter_t final : public details::unit_t<double, std::ratio<1, 1000000>, mass_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1, 1000000>, mass_concentration_v>;
    using _base::_base;
...
struct milligram_per_cubic_meter_t final : public details::unit_t<double, std::ratio<1, 1000000>, mass_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1, 1000000>, mass_concentration_v>;
    using _base::_base;
...
struct microgram_per_liter_t final : public details::unit_t<double, std::ratio<1, 1000000000>, mass_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1, 1000000000>, mass_concentration_v>;
    using _base::_base;
...
struct microgram_per_cubic_meter_t final : public details::unit_t<double, std::ratio<1, 1000000000>, mass_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1, 1000000000>, mass_concentration_v>;
    using _base::_base;
...
struct parts_per_million_t final : public details::unit_t<double, std::ratio<1, 1000000>, mass_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1, 1000000>, mass_concentration_v>;
    using _base::_base;
...
struct parts_per_billion_t final : public details::unit_t<double, std::ratio<1, 1000000000>, mass_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1, 1000000000>, mass_concentration_v>;
    using _base::_base;
...
struct mole_per_cubic_meter final : public details::unit_t<double, std::ratio<1, 1>, molar_concentration_v>
{
...
struct mole_per_liter final : public details::unit_t<double, std::ratio<1000, 1>, molar_concentration_v>
{
...
struct molar final : public details::unit_t<double, std::ratio<1000, 1>, molar_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1000, 1>, molar_concentration_v>;
    using _base::_base;
...
struct millimolar final : public details::unit_t<double, std::ratio<1, 1>, molar_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1, 1>, molar_concentration_v>;
    using _base::_base;
...
struct micromolar final : public details::unit_t<double, std::ratio<1, 1000>, molar_concentration_v>
{
...
struct nanomolar final : public details::unit_t<double, std::ratio<1, 1000000>, molar_concentration_v>
{
...
struct picomolar final : public details::unit_t<double, std::ratio<1, 1000000000>, molar_concentration_v>
{
...
struct mole_per_cubic_centimeter final : public details::unit_t<double, std::ratio<1000000000, 1>, molar_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1000000000, 1>, molar_concentration_v>;
    using _base::_base;
...
struct mole_per_milliliter final : public details::unit_t<double, std::ratio<1000000000, 1>, molar_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1000000000, 1>, molar_concentration_v>;
    using _base::_base;
...
struct osmole_per_liter final : public details::unit_t<double, std::ratio<1000, 1>, molar_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1000, 1>, molar_concentration_v>;
    using _base::_base;
...
struct milliosmole_per_liter final : public details::unit_t<double, std::ratio<1, 1>, molar_concentration_v>
{
    using _base = details::unit_t<double, std::ratio<1, 1>, molar_concentration_v>;
    using _base::_base;
...
template<>
struct details::named_unit_type_t<double, std::ratio<1, 1>, mass_concentration_v>
{
    using type = kilogram_per_cubic_meter_t;
};

template<>
struct details::named_unit_type_t<double, std::ratio<1, 1000>, mass_concentration_v>
{
    using type = gram_per_cubic_meter_t;
};

template<>
struct details::named_unit_type_t<double, std::ratio<1, 1000000>, mass_concentration_v>
{
    using type = milligram_per_liter_t;
};

template<>
struct details::named_unit_type_t<double, std::ratio<1, 1000000000>, mass_concentration_v>
{
...
template<>
struct details::named_unit_type_t<double, std::ratio<1000000000, 1>, molar_concentration_v>
{
