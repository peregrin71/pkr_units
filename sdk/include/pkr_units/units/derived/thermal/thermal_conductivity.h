...
struct thermal_conductivity_t final : public details::unit_t<double, std::ratio<1, 1>, thermal_conductivity_dimension>
{
    ...
    using _base::_base;
    static constexpr std::string_view name{"thermal_conductivity"};
    static constexpr std::string_view symbol{"W/(m*K)"};
    static constexpr std::wstring_view w_symbol{L"W·m⁻¹·K⁻¹"};
    static constexpr std::u8string_view u8_symbol{u8"W·m⁻¹·K⁻¹"};
};
