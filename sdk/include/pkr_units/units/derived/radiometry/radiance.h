...
// Unit: watt per square meter per steradian (W/(mÂ²Â·sr))
// Dimension: [MÂ·Tâ»Â³Â·srâ»Â¹]
//
// CHARACTERISTICS:
...
// - Radiance = Irradiance / Solid angle [W / (mÂ² Â· sr)]
// - Radiant intensity = Radiance Ã— Projected area [(W/(mÂ²Â·sr)) Ã— mÂ² = W/sr]
//
// BLACKBODY RADIATION:
// Stefan-Boltzmann Law: Radiance = ÏƒÂ·Tâ´ (for perfect blackbody)
// where Ïƒ = 5.67Ã—10â»â¸ W/(mÂ²Â·Kâ´)
//
// PLANCK'S LAW:
// Spectral radiance describes wavelength-dependent radiation
// L(Î»,T) = (2hcÂ²/Î»âµ) / (exp(hc/Î»kT) - 1) [W/(mÂ³Â·sr)]
//
// TYPICAL VALUES:
// - Tungsten filament (2000K): ~1 MW/(mÂ²Â·sr)
// - Human skin (310K): ~500 W/(mÂ²Â·sr) in infrared
// - Clear blue sky: ~1000-3000 W/(mÂ²Â·sr) in visible
// - Black coal at 300K: ~10 W/(mÂ²Â·sr) in far IR
//
// APPLICATIONS:
