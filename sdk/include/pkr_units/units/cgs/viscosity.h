...
struct poise_t final : public details::unit_t<double, std::ratio<1, 10>, dynamic_viscosity_dimension>
{
    ...
    using _base::_base;
    static constexpr std::string_view name{"poise"};
    static constexpr std::string_view symbol{"P"};
    static constexpr std::wstring_view w_symbol{L"P"};
    static constexpr std::u8string_view u8_symbol{u8"P"};
};
...
struct stokes_t final : public details::unit_t<double, std::ratio<1, 10000>, kinematic_viscosity_dimension>
{
    ...
    using _base::_base;
    static constexpr std::string_view name{"stokes"};
