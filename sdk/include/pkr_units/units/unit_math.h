...
// automatic ratio conversion and type safety
...
constexpr auto
    pow(const PKR_UNITS_NAMESPACE::details::unit_t<T, Ratio, Dim>& base, const PKR_UNITS_NAMESPACE::details::unit_t<ExpT, ExpRatio, scalar_dimension>& exponent)
{
