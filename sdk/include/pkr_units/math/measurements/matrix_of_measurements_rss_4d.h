...
public:
    ...
    constexpr matrix_4d_measurements_t(const array_type& arr) : data(arr) {}
    ...
    constexpr std::array<T, 4>& operator[](size_t row) { return data[row]; }
    constexpr const std::array<T, 4>& operator[](size_t row) const { return data[row]; }
};
    ...
    return vec_4d_t<T>{
        pkr::units::math::add_rss(
            ...
            pkr::units::math::add_rss(
                ...
                pkr::units::math::multiply_rss(m.data[0][3], v.w)
            )
        ),
        pkr::units::math::add_rss(
            pkr::units::math::add_rss(
            ...
            pkr::units::math::add_rss(
                ...
                pkr::units::math::multiply_rss(m.data[1][3], v.w)
            )
        ),
        pkr::units::math::add_rss(
            pkr::units::math::add_rss(
            ...
            pkr::units::math::add_rss(
                ...
                pkr::units::math::multiply_rss(m.data[2][3], v.w)
            )
        ),
        pkr::units::math::add_rss(
            pkr::units::math::add_rss(
                pkr::units::math::multiply_rss(m.data[3][0], v.x),
                pkr::units::math::multiply_rss(m.data[3][1], v.y)
            ),
            pkr::units::math::add_rss(
                pkr::units::math::multiply_rss(m.data[3][2], v.z),
                pkr::units::math::multiply_rss(m.data[3][3], v.w)
            )
        )
    };
}
