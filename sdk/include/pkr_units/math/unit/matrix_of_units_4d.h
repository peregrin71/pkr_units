...
public:
    ...
    constexpr matrix_4d_units_t(const array_type& arr) : data(arr) {}
    ...
    return vec_4d_t<T>{
        stable_add(
            ...
            stable_add(
                ...
                stable_multiply(m.data[0][3], v.w)
            )
        ),
        stable_add(
            stable_add(
            ...
            stable_add(
                ...
                stable_multiply(m.data[1][3], v.w)
            )
        ),
        stable_add(
            stable_add(
            ...
            stable_add(
                ...
                stable_multiply(m.data[2][3], v.w)
            )
        ),
        stable_add(
            stable_add(
                stable_multiply(m.data[3][0], v.x),
                stable_multiply(m.data[3][1], v.y)
            ),
            stable_add(
                stable_multiply(m.data[3][2], v.z),
                stable_multiply(m.data[3][3], v.w)
            )
        )
    };
}
